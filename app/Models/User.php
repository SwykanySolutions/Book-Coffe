...
class User extends Authenticatable
{
    ...
    {
        return !$this->attributes['profile_photo'] ? asset("imgs/profile.avif") : $this->attributes['profile_photo'];
    }

    public function getBackgroundPhotoAttribute()
    {
        return !$this->attributes['background_photo'] ? asset("imgs/background_photo.avif") : $this->attributes['background_photo'];
    }
